...
BASE_URL = os.getenv(
    "WEBARENA_BASE_URL",
    "http://ec2-18-218-205-96.us-east-2.compute.amazonaws.com:8082/",
)
API_PREFIX = "/rest/V1"
...
class AddressData(BaseModel):
    ...
    region_id: Optional[int] = Field(
        default=None, description="Region/State ID"
    )
...
async def customer_logout() -> Dict[str, Any]:
    ...
    """
    result = await make_request(
        "POST", "/integration/customer/revoke-customer-token"
    )
...
async def reset_password_request(
    email: str, template: str = "email_reset"
) -> Dict[str, Any]:
    """
    ...
    return await make_request(
        "PUT",
        "/customers/password",
        {"email": email, "template": template, "websiteId": 1},
    )
...
async def get_products(
    ...
    if sort_field:
        ...
        if sort_direction:
            params += (
                f"&searchCriteria[sortOrders][0][direction]={sort_direction}"
            )

    return await make_request("GET", f"/products{params}")
...
async def get_product_by_sku(sku: str) -> Dict[str, Any]:
    ...
    GET /V1/products/:sku
    """
    return await make_request("GET", f"/products/{sku}")


@mcp.tool()
async def create_product(
    product: ProductData, use_admin: bool = True
) -> Dict[str, Any]:
    """
...
async def update_product(
    sku: str, updates: Dict[str, Any], use_admin: bool = True
) -> Dict[str, Any]:
    """
    ...
    return await make_request(
        "PUT", f"/products/{sku}", data, use_admin=use_admin
    )
...
async def get_product_attributes() -> Dict[str, Any]:
    ...
    """
    return await make_request(
        "GET", "/products/attributes?searchCriteria[pageSize]=100"
    )
...
async def get_product_types() -> Dict[str, Any]:
    ...
    """
    return await make_request("GET", "/products/types")


@mcp.tool()
async def search_products(
    search_term: str, page_size: int = 20
) -> Dict[str, Any]:
    """
...
async def get_categories() -> Dict[str, Any]:
    ...
    GET /V1/categories
    """
    return await make_request("GET", "/categories")
...
async def get_category_products(category_id: int) -> Dict[str, Any]:
    ...
    """
    return await make_request("GET", f"/categories/{category_id}/products")
...
async def add_to_guest_cart(
    cart_id: str, sku: str, qty: float
) -> Dict[str, Any]:
    """
    Add item to guest cart
    POST /V1/guest-carts/:cartId/items
    """
    data = {"cartItem": {"sku": sku, "qty": qty, "quote_id": cart_id}}
...
async def update_cart_item(item_id: int, qty: float) -> Dict[str, Any]:
    ...
    """
    data = {"cartItem": {"qty": qty, "item_id": item_id}}
...
async def place_order(payment_method: str = "checkmo") -> Dict[str, Any]:
    ...
    """
    data = {"paymentMethod": {"method": payment_method}}
...
async def cancel_order(order_id: int) -> Dict[str, Any]:
    ...
    """
    return await make_request(
        "POST", f"/orders/{order_id}/cancel", use_admin=True
    )


@mcp.tool()
async def add_order_comment(
    order_id: int, comment: str, is_visible: bool = True
) -> Dict[str, Any]:
    """
    ...
    return await make_request(
        "POST", f"/orders/{order_id}/comments", data, use_admin=True
    )
...
async def create_invoice(order_id: int) -> Dict[str, Any]:
    ...
    """
    return await make_request(
        "POST", f"/order/{order_id}/invoice", {}, use_admin=True
    )
...
async def create_shipment(order_id: int) -> Dict[str, Any]:
    ...
    """
    return await make_request(
        "POST", f"/order/{order_id}/ship", {}, use_admin=True
    )
...
async def get_customers(
    ...
    params = f"?searchCriteria[pageSize]={page_size}&searchCriteria[currentPage]={current_page}"
    return await make_request(
        "GET", f"/customers/search{params}", use_admin=True
    )
...
async def get_customer(customer_id: int) -> Dict[str, Any]:
    ...
    """
    return await make_request(
        "GET", f"/customers/{customer_id}", use_admin=True
    )


@mcp.tool()
async def update_customer(
    customer_id: int, updates: Dict[str, Any]
) -> Dict[str, Any]:
    """
    ...
    return await make_request(
        "PUT", f"/customers/{customer_id}", data, use_admin=True
    )
...
async def delete_customer(customer_id: int) -> Dict[str, Any]:
    ...
    """
    return await make_request(
        "DELETE", f"/customers/{customer_id}", use_admin=True
    )
...
async def get_customer_groups() -> Dict[str, Any]:
    ...
    """
    return await make_request(
        "GET", "/customerGroups/search?searchCriteria[pageSize]=100"
    )
...
async def get_stock_status(sku: str) -> Dict[str, Any]:
    ...
    """
    return await make_request("GET", f"/stockStatuses/{sku}")
...
async def check_product_salable(sku: str, stock_id: int = 1) -> Dict[str, Any]:
    ...
    """
    return await make_request(
        "GET", f"/inventory/is-product-salable/{sku}/{stock_id}"
    )
...
async def get_sources() -> Dict[str, Any]:
    ...
    """
    return await make_request("GET", "/inventory/sources")
...
async def get_stocks() -> Dict[str, Any]:
    ...
    """
    return await make_request("GET", "/inventory/stocks")
...
async def get_store_config() -> Dict[str, Any]:
    ...
    """
    return await make_request("GET", "/store/storeConfigs")
...
async def get_websites() -> Dict[str, Any]:
    ...
    """
    return await make_request("GET", "/store/websites")
...
async def get_store_views() -> Dict[str, Any]:
    ...
    """
    return await make_request("GET", "/store/storeViews")
...
async def get_cms_pages(page_size: int = 20) -> Dict[str, Any]:
    ...
    return await make_request("GET", f"/cmsPage/search{params}")
...
async def get_cms_page(page_id: int) -> Dict[str, Any]:
    ...
    GET /V1/cmsPage/:id
    """
    return await make_request("GET", f"/cmsPage/{page_id}")
...
async def get_cms_blocks(page_size: int = 20) -> Dict[str, Any]:
    ...
    """
    params = f"?searchCriteria[pageSize]={page_size}"
    return await make_request("GET", f"/cmsBlock/search{params}")
...
async def get_tax_classes() -> Dict[str, Any]:
    ...
    """
    return await make_request(
        "GET", "/taxClasses/search?searchCriteria[pageSize]=100"
    )
...
async def get_tax_rates() -> Dict[str, Any]:
    ...
    """
    return await make_request(
        "GET", "/taxRates/search?searchCriteria[pageSize]=100"
    )
...
async def get_tax_rules() -> Dict[str, Any]:
    ...
    """
    return await make_request(
        "GET", "/taxRules/search?searchCriteria[pageSize]=100"
    )
...
async def get_sales_rules(page_size: int = 20) -> Dict[str, Any]:
    ...
    params = f"?searchCriteria[pageSize]={page_size}"
    return await make_request(
        "GET", f"/salesRules/search{params}", use_admin=True
    )
...
async def set_auth_token(
    token: str, token_type: str = "customer"
) -> Dict[str, str]:
    """
...
async def get_current_tokens() -> Dict[str, Any]:
    ...
    return {
        "customer_token": (
            auth_tokens["customer"][:10] + "..."
            if auth_tokens["customer"]
            else None
        ),
        "admin_token": (
            auth_tokens["admin"][:10] + "..." if auth_tokens["admin"] else None
        ),
    }
