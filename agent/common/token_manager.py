...
async def authenticate_and_save_tokens(
    ...
    """
    Authenticate using login tools and save tokens to TokenStore and .env file.
    
    Args:
        tools: Dictionary of available tools
        token_store: TokenStore instance to update
        config: Configurator instance to get .env file path
        ...
        save_to_env: Whether to save tokens to .env file (default: True)
...
async def setup_authentication(tools: Dict[str, Any], token_store: TokenStore, config: Configurator):
    ...
    This function will prompt for credentials and save tokens to both TokenStore and .env file.
    """
